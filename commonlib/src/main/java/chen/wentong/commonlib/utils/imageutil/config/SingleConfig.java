...
public class SingleConfig {
    ...
    private ViewPropertyTransition.Animator animator;       //设置加载图片时的动画
    ...
    private BitmapListener bitmapListener;                  //加载图片监听，可以自定义图片转换操作
    ...
    public void setBitmapListener(BitmapListener bitmapListener) {
        this.bitmapListener = ImgLoaderUtil.getBitmapListenerProxy(bitmapListener);
    }
    ...
    public static class ConfigBuilder {
        ...
        private boolean isNeedContrast = false; //是否需要锐化
         ...
         * @return
         */
        public ConfigBuilder setNeedVignette(boolean needVignette) {
            isNeedVignette = needVignette;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setNeedSketch(boolean needSketch) {
            isNeedSketch = needSketch;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setPixelationLevel(float pixelationLevel) {
        ...
        /**
         * 是否需要马赛克
         * @param needPixelation
         * @return
         */
        public ConfigBuilder setNeedPixelation(boolean needPixelation) {
            isNeedPixelation = needPixelation;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setNeedInvert(boolean needInvert) {
            isNeedInvert = needInvert;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setContrastLevel(float contrastLevel) {
         ...
         * @return
         */
        public ConfigBuilder setNeedContrast(boolean needContrast) {
            isNeedContrast = needContrast;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setNeedSepia(boolean needSepia) {
            isNeedSepia = needSepia;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setNeedToon(boolean needToon) {
            isNeedToon = needToon;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setNeedSwirl(boolean needSwirl) {
            isNeedSwirl = needSwirl;
            return this;
        }
         ...
         * @return
         */
        public ConfigBuilder setNeedGrayscale(boolean needGrayscale) {
            isNeedGrayscale = needGrayscale;
            return this;
        }

        /**
         * 是否需要高亮
         * @param needBrightness
         * @return
         */
        public ConfigBuilder setNeedBrightness(boolean needBrightness) {
            isNeedBrightness = needBrightness;
            return this;
        }
