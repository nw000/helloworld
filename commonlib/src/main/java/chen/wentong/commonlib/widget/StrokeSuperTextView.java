...
/**
 * Created by wentong.chen on 17/4/21.
 */

public class StrokeSuperTextView extends TextView {
    ...
    public StrokeSuperTextView(Context context) {
        super(context);
        init(null);
    }

    public StrokeSuperTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public StrokeSuperTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray =
                    getContext().obtainStyledAttributes(attrs, R.styleable.StrokeSuperTextView);
            corner = typedArray.getDimension(R.styleable.StrokeSuperTextView_corner, DEFAULT_CORNER);
            leftTopCornerEnable =
                    typedArray.getBoolean(R.styleable.StrokeSuperTextView_left_top_corner, false);
            rightTopCornerEnable =
                    typedArray.getBoolean(R.styleable.StrokeSuperTextView_right_top_corner, false);
            leftBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.StrokeSuperTextView_left_bottom_corner, false);
            rightBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.StrokeSuperTextView_right_bottom_corner, false);
            solid = typedArray.getColor(R.styleable.StrokeSuperTextView_solid, DEFAULT_SOLID);
            strokeWidth = typedArray.getDimension(R.styleable.StrokeSuperTextView_stroke_width,
                    DEFAULT_STROKE_WIDTH);
            strokeColor =
                    typedArray.getColor(R.styleable.StrokeSuperTextView_stroke_color, DEFAULT_STROKE_COLOR);
            drawable = typedArray.getDrawable(R.styleable.StrokeSuperTextView_state_drawable);
            drawableWidth =
                    typedArray.getDimension(R.styleable.StrokeSuperTextView_state_drawable_width, 0);
            drawableHeight =
                    typedArray.getDimension(R.styleable.StrokeSuperTextView_state_drawable_height, 0);
            drawablePaddingLeft =
                    typedArray.getDimension(R.styleable.StrokeSuperTextView_state_drawable_padding_left, 0);
            drawablePaddingTop =
                    typedArray.getDimension(R.styleable.StrokeSuperTextView_state_drawable_padding_top, 0);
            isShowState = typedArray.getBoolean(R.styleable.StrokeSuperTextView_isShowState, false);
            stateDrawableMode = typedArray.getInteger(R.styleable.StrokeSuperTextView_state_drawable_mode,
                    DEFAULT_STATE_DRAWABLE_MODE);
            textStroke = typedArray.getBoolean(R.styleable.StrokeSuperTextView_text_stroke, false);
            textStrokeColor = typedArray.getColor(R.styleable.StrokeSuperTextView_text_stroke_color,
                    DEFAULT_TEXT_STROKE_COLOR);
            textFillColor = typedArray.getColor(R.styleable.StrokeSuperTextView_text_fill_color,
                    DEFAULT_TEXT_FILL_COLOR);
            textStrokeWidth = typedArray.getDimension(R.styleable.StrokeSuperTextView_text_stroke_width,
                    DEFAULT_TEXT_STROKE_WIDTH);
            autoAdjust = typedArray.getBoolean(R.styleable.StrokeSuperTextView_autoAdjust, false);
            typedArray.recycle();
        }
    }
    ...
    public static abstract class Adjuster {
        ...
        protected abstract void adjust(StrokeSuperTextView v, Canvas canvas);

        public boolean onTouch(StrokeSuperTextView v, MotionEvent event) {
            return false;
        };
    ...
    public static class DefaultAdjuster extends Adjuster {
        ...
        @Override
        public void adjust(StrokeSuperTextView v, Canvas canvas) {
            int length = v.length();
